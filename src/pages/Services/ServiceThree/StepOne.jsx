...
const StepOne = ({toggleSidebar}) => {
	...
	return (
		<li className='Stepper__content-item is--active'>
			...
			<div className='Stepper__item-row'>
				<Select placeholder='اختر وظيفة' label='الوظيفة' options={[]} name="rank" />
			</div>
			...
			<div className='Stepper__item-row'>
				<Select placeholder='اختر الموقع' label='الموقع' options={[]} name="location" />
			</div>

			<div className='Stepper__item-row'>
				<SearchUser size='form' placeholder='اكتب اسم المشروع ' label='اسم المشروع'/>
			</div>
