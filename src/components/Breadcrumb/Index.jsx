		...
		<nav className="Breadcrumb">
			<ul>
				...
				{pathSegments.map((segment, index) => (
					<li key={index} className={index === pathSegments.length - 1 ? 'Breadcrumb__active' : ''}>
